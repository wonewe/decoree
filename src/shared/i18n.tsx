...
const translations: TranslationDictionary = {
  fr: {
    ...
    messages: {
      ...
      "hero.search.label": "Rechercher une tendance",
      "hero.search.placeholder": "Ex : 성수 팝업, 한강, 제로프루프, 한양대",
      "hero.search.cta": "Rechercher",
      "hero.search.helper": "Cherchez dans les tendances, pop-ups, événements et phrasebook.",
      "search.title": "Recherche koraid",
      "search.headline": "Un seul champ pour explorer tout le contenu",
      "search.subtitle": "Tapez un quartier, une marque ou un mot-clé pour fouiller tendances, pop-ups, événements et phrasebook.",
      "search.emptyPrompt": "Commencez par saisir un mot-clé ou un quartier.",
      "search.loading": "Recherche en cours...",
      "search.noResults": "Aucun résultat pour cette recherche.",
      "search.section.trend": "Trends",
      "search.section.event": "Événements",
      "search.section.popup": "Pop-ups",
      "search.section.phrase": "Phrasebook",
      "search.badge.trend": "Trend",
      "search.badge.event": "Événement",
      "search.badge.popup": "Pop-up",
      "search.badge.phrase": "Phrase",
  ...
  ko: {
    ...
    messages: {
      ...
      "hero.search.label": "트렌드 검색",
      "hero.search.placeholder": "예: 성수 팝업, 한강, 제로프루프, 한양대",
      "hero.search.cta": "검색",
      "hero.search.helper": "트렌드, 팝업, 이벤트, 회화장 전체에서 찾아볼 수 있어요.",
      "search.title": "koraid 검색",
      "search.headline": "한 번에 전 콘텐츠 검색",
      "search.subtitle": "동네, 브랜드, 키워드를 입력하면 트렌드·팝업·이벤트·회화장을 함께 찾아드립니다.",
      "search.emptyPrompt": "먼저 검색어를 입력해 주세요.",
      "search.loading": "검색 중...",
      "search.noResults": "검색 결과가 없습니다.",
      "search.section.trend": "트렌드",
      "search.section.event": "이벤트",
      "search.section.popup": "팝업",
      "search.section.phrase": "회화장",
      "search.badge.trend": "Trend",
  ...
  ja: {
    ...
    messages: {
      ...
      "hero.search.label": "トレンド検索",
      "hero.search.placeholder": "例: 聖水ポップアップ、漢江、ゼロプルーフ、漢陽大",
      "hero.search.cta": "検索",
      "hero.search.helper": "トレンド・ポップアップ・イベント・フレーズから横断検索します。",
      "search.title": "koraid検索",
      "search.headline": "1つの検索で全コンテンツを横断",
      "search.subtitle": "エリア名やブランド、キーワードでトレンド・ポップアップ・イベント・フレーズをまとめて探します。",
      "search.emptyPrompt": "まず検索キーワードを入力してください。",
      "search.loading": "検索中...",
      "search.noResults": "該当する結果がありません。",
      "search.section.trend": "トレンド",
      "search.section.event": "イベント",
      "search.section.popup": "ポップアップ",
      "search.section.phrase": "フレーズ",
      "search.badge.trend": "Trend",
      "search.badge.event": "Event",
      "search.badge.popup": "Pop-up",
      "search.badge.phrase": "Phrase",
  ...
  en: {
    ...
    messages: {
      ...
      "hero.search.label": "Search trends",
      "hero.search.placeholder": "e.g. Seongsu pop-up, Han River, zero-proof, Hanyang Univ",
      "hero.search.cta": "Search",
      "hero.search.helper": "Search across trends, pop-ups, events, and the phrasebook.",
      "search.title": "koraid search",
      "search.headline": "One bar to search everything",
      "search.subtitle": "Type a neighborhood, brand, or keyword to search trends, pop-ups, events, and the phrasebook.",
      "search.emptyPrompt": "Start by entering a keyword.",
      "search.loading": "Searching...",
      "search.noResults": "No results found for this query.",
      "search.section.trend": "Trends",
      "search.section.event": "Events",
      "search.section.popup": "Pop-ups",
      "search.section.phrase": "Phrasebook",
      "search.badge.trend": "Trend",
      "search.badge.event": "Event",
