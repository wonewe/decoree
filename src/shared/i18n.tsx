  ...
  fr: {
    ...
    messages: {
      ...
      "hero.description.paragraph1":
        "Premier voyage ou déjà sur place, koraid vous guide dans les dernières tendances, les pop-ups à ne pas manquer et les expressions que les locaux utilisent vraiment. Nos rapports hebdomadaires décodent ce qui se passe dans les quartiers branchés de Séoul, de Gangnam à Hongdae.",
      "hero.description.paragraph2":
        "Calendrier d'événements K-culture, festivals et pop-ups exclusifs. Créez votre phrasebook personnalisé selon vos intérêts—K-pop, cuisine coréenne ou startups tech.",
      ...
      "popupRadar.description":
        "Collaborations limitées, cafés concept et expériences exclusives. Notre radar suit les pop-ups à Séoul, Busan et Jeju pour découvrir des expériences uniques avant qu'elles ne disparaissent.",
      ...
      "trends.description":
        "Notre équipe à Séoul suit les dernières tendances mode, gastronomie, divertissement et lifestyle. Rapports hebdomadaires sur ce qui est tendance dans les quartiers comme Myeongdong, Itaewon et Seongsu.",
      "trends.description.link": "Suivez",
      "trends.description.linkText": "#Seoul",
      "trends.description.linkSuffix": "sur Instagram pour plus d'inspiration.",
      "trends.description2":
        "Explorez nos archives pour découvrir des pépites cachées et les meilleurs endroits à visiter.",
      ...
      "home.about.paragraph1":
        "La Corée, c'est plus que le K-pop et le kimchi. Un pays dynamique où tradition et innovation se rencontrent, avec de nouvelles tendances chaque semaine.",
      "home.about.paragraph2":
        "Notre équipe basée à Séoul explore la ville pour vous apporter les dernières informations. Des cafés cachés de Seongsu aux pop-ups de Gangnam, nous couvrons les tendances importantes.",
      ...
      "home.tutoring.badge": "Korean Tutoring",
      "home.tutoring.title": "Apprenez le coréen avec des tuteurs Gen Z",
      "home.tutoring.subtitle": "Des cours personnalisés basés sur les tendances actuelles, enseignés par de jeunes Coréens passionnés.",
      "home.tutoring.cta": "Découvrir",
      "home.tutoring.card.title": "Cours de coréen personnalisés",
      "home.tutoring.card.description": "Apprenez le coréen du quotidien avec des tuteurs qui comprennent la culture moderne. Des expressions tendance aux situations réelles.",
      "home.tutoring.card.cta": "En savoir plus",
      "home.tutoring.advantage.trendBased.title": "Apprentissage basé sur les tendances",
      "home.tutoring.advantage.trendBased.description": "Apprenez avec du contenu actuel : K-pop, dramas, argot internet et expressions virales.",
      "home.tutoring.advantage.genZPeer.title": "Tuteurs Gen Z",
      "home.tutoring.advantage.genZPeer.description": "Pratiquez avec des jeunes Coréens qui parlent comme les locaux et comprennent votre génération.",
      "home.tutoring.advantage.realLifeMission.title": "Missions réelles",
      "home.tutoring.advantage.realLifeMission.description": "Mettez en pratique vos connaissances avec des défis concrets : commander au café, parler aux locaux.",
      "home.membership.badge": "Abonnement",
      "home.membership.title": "Choisissez votre formule",
      "home.membership.subtitle": "Des options flexibles pour tous les niveaux et objectifs d'apprentissage.",
      "home.membership.basic.title": "Basic",
      "home.membership.basic.price": "€49",
      "home.membership.basic.sessions": "4 sessions / mois",
      "home.membership.basic.feature1": "Sessions 1-on-1 de 50 min",
      "home.membership.basic.feature2": "Matériel d'apprentissage inclus",
      "home.membership.pro.badge": "Populaire",
      "home.membership.pro.title": "Pro",
      "home.membership.pro.price": "€89",
      "home.membership.pro.sessions": "8 sessions / mois",
      "home.membership.pro.feature1": "Sessions 1-on-1 de 50 min",
      "home.membership.pro.feature2": "Matériel d'apprentissage inclus",
      "home.membership.pro.feature3": "Support prioritaire",
      "home.membership.learnMore": "En savoir plus",
      "home.membership.getStarted": "Commencer",
      "home.membership.viewAll": "Voir toutes les formules"
    }
  },
  ko: {
    label: "한국어",
    messages: {
      ...
      "hero.description.paragraph1":
        "첫 방문이든 재방문이든, koraid가 최신 트렌드와 인기 팝업, 현지인이 쓰는 표현을 알려드립니다. 주간 리포트로 강남부터 홍대까지 서울 핫플레이스를 파악하세요.",
      "hero.description.paragraph2":
        "K-컬처 콘서트와 페스티벌, 독점 팝업을 한눈에 보는 이벤트 캘린더. 관심사에 맞춘 맞춤형 회화장도 만들어보세요.",
      ...
      "popupRadar.description":
        "한정 기간 협업, 컨셉 카페, 독점 브랜드 경험. 우리 레이더가 서울, 부산, 제주의 팝업을 추적해 사라지기 전에 독특한 경험을 발견할 수 있도록 도와줍니다.",
      ...
      "trends.description":
        "서울에 있는 우리 팀이 패션, 음식, 엔터테인먼트, 라이프스타일 전반의 최신 트렌드를 추적합니다. 매주 명동, 이태원, 성수동 같은 동네의 유행을 상세히 리포트합니다.",
      "trends.description.link": "더 많은 인사이트는 인스타그램",
      "trends.description.linkText": "#Seoul",
      "trends.description.linkSuffix": "을 팔로우하세요.",
      "trends.description2":
        "아카이브를 탐색해 숨겨진 보석을 발견하고 방문할 최고의 장소를 찾아보세요.",
      ...
      "home.about.paragraph1":
        "한국은 K-pop과 김치 이상입니다. 전통과 혁신이 만나고 매주 새로운 트렌드가 등장하는 역동적인 국가입니다.",
      "home.about.paragraph2":
        "서울에 기반을 둔 우리 팀이 도시를 탐험하며 최신 인사이트를 제공합니다. 성수동의 숨겨진 카페부터 강남의 팝업 스토어까지, 중요한 트렌드를 다룹니다.",
      ...
      "home.tutoring.badge": "한국어 튜터링",
      "home.tutoring.title": "Gen Z 튜터와 함께 한국어를 배워요",
      "home.tutoring.subtitle": "최신 트렌드를 반영한 맞춤형 수업, 열정 가득한 젊은 한국인 튜터와 함께합니다.",
      "home.tutoring.cta": "자세히 보기",
      "home.tutoring.card.title": "맞춤형 한국어 수업",
      "home.tutoring.card.description": "현대 문화를 이해하는 튜터와 일상 한국어를 배워보세요. 트렌디한 표현부터 실생활 상황까지.",
      "home.tutoring.card.cta": "더 알아보기",
      "home.tutoring.advantage.trendBased.title": "트렌드 기반 학습",
      "home.tutoring.advantage.trendBased.description": "K-pop, 드라마, 인터넷 신조어, 바이럴 표현 등 최신 콘텐츠로 학습합니다.",
      "home.tutoring.advantage.genZPeer.title": "Gen Z 튜터",
      "home.tutoring.advantage.genZPeer.description": "실제 한국 젊은이들처럼 말하고 여러분의 세대를 이해하는 튜터와 연습하세요.",
      "home.tutoring.advantage.realLifeMission.title": "실생활 미션",
      "home.tutoring.advantage.realLifeMission.description": "카페에서 주문하기, 현지인과 대화하기 등 실제 도전과제로 배운 내용을 실습합니다.",
      "home.membership.badge": "멤버십",
      "home.membership.title": "나에게 맞는 플랜 선택",
      "home.membership.subtitle": "모든 레벨과 학습 목표에 맞는 유연한 옵션을 제공합니다.",
      "home.membership.basic.title": "Basic",
      "home.membership.basic.price": "₩65,000",
      "home.membership.basic.sessions": "월 4회 세션",
      "home.membership.basic.feature1": "50분 1:1 세션",
      "home.membership.basic.feature2": "학습 자료 포함",
      "home.membership.pro.badge": "인기",
      "home.membership.pro.title": "Pro",
      "home.membership.pro.price": "₩119,000",
      "home.membership.pro.sessions": "월 8회 세션",
      "home.membership.pro.feature1": "50분 1:1 세션",
      "home.membership.pro.feature2": "학습 자료 포함",
      "home.membership.pro.feature3": "우선 지원",
      "home.membership.learnMore": "자세히 보기",
      "home.membership.getStarted": "시작하기",
      "home.membership.viewAll": "모든 플랜 보기"
    }
  },
  ja: {
    label: "日本語",
    messages: {
      ...
      "hero.description.paragraph1":
        "初めてでも再訪でも、koraidが最新トレンド、人気ポップアップ、現地で使われる表現を紹介します。週間レポートで江南から弘大まで、ソウルのホットスポットを把握しましょう。",
      "hero.description.paragraph2":
        "K-カルチャーコンサートやフェス、独占ポップアップを一目で見られるイベントカレンダー。興味に合わせたパーソナル会話帳も作成できます。",
      ...
      "popupRadar.description":
        "期間限定コラボ、コンセプトカフェ、独占ブランド体験。私たちのレーダーがソウル、釜山、済州のポップアップを追跡し、消える前にユニークな体験を発見できます。",
      ...
      "trends.description":
        "ソウルにいる私たちのチームがファッション、食べ物、エンターテインメント、ライフスタイル全般の最新トレンドを追跡。毎週、明洞、梨泰院、聖水洞などの地域の流行を詳細にレポートします。",
      "trends.description.link": "より多くのインサイトはInstagramの",
      "trends.description.linkText": "#Seoul",
      "trends.description.linkSuffix": "をフォローしてください。",
      "trends.description2":
        "アーカイブを探索して隠れた宝石を発見し、訪れる最高の場所を見つけてください。",
      ...
      "home.about.paragraph1":
        "韓国はK-popとキムチ以上のものです。伝統と革新が出会い、毎週新しいトレンドが出現するダイナミックな国です。",
      "home.about.paragraph2":
        "ソウルに拠点を置く私たちのチームが街を探索し、最新のインサイトを提供します。聖水洞の隠れたカフェから江南のポップアップストアまで、重要なトレンドをカバーしています。",
      ...
      "home.tutoring.badge": "韓国語チューター",
      "home.tutoring.title": "Gen Zチューターと韓国語を学ぼう",
      "home.tutoring.subtitle": "最新トレンドに基づいたパーソナライズされたレッスンを、情熱あふれる若い韓国人チューターと一緒に。",
      "home.tutoring.cta": "詳しく見る",
      "home.tutoring.card.title": "パーソナライズされた韓国語レッスン",
      "home.tutoring.card.description": "現代文化を理解するチューターと日常韓国語を学びましょう。トレンド表現から実生活の場面まで。",
      "home.tutoring.card.cta": "もっと見る",
      "home.tutoring.advantage.trendBased.title": "トレンドベースの学習",
      "home.tutoring.advantage.trendBased.description": "K-pop、ドラマ、ネットスラング、バイラル表現など最新コンテンツで学習します。",
      "home.tutoring.advantage.genZPeer.title": "Gen Zチューター",
      "home.tutoring.advantage.genZPeer.description": "韓国の若者のように話し、あなたの世代を理解するチューターと練習しましょう。",
      "home.tutoring.advantage.realLifeMission.title": "実生活ミッション",
      "home.tutoring.advantage.realLifeMission.description": "カフェでの注文、地元の人との会話など、実際のチャレンジで学んだことを実践します。",
      "home.membership.badge": "メンバーシップ",
      "home.membership.title": "あなたに合ったプランを選ぼう",
      "home.membership.subtitle": "すべてのレベルと学習目標に対応した柔軟なオプション。",
      "home.membership.basic.title": "Basic",
      "home.membership.basic.price": "¥7,500",
      "home.membership.basic.sessions": "月4セッション",
      "home.membership.basic.feature1": "50分の1対1セッション",
      "home.membership.basic.feature2": "学習教材付き",
      "home.membership.pro.badge": "人気",
      "home.membership.pro.title": "Pro",
      "home.membership.pro.price": "¥13,500",
      "home.membership.pro.sessions": "月8セッション",
      "home.membership.pro.feature1": "50分の1対1セッション",
      "home.membership.pro.feature2": "学習教材付き",
      "home.membership.pro.feature3": "優先サポート",
      "home.membership.learnMore": "詳しく見る",
      "home.membership.getStarted": "始める",
      "home.membership.viewAll": "すべてのプランを見る"
    }
  },
  en: {
    label: "English",
    messages: {
      ...
      "hero.description.paragraph1":
        "Whether it's your first trip or you're already here, koraid helps you navigate the latest trends, discover must-visit pop-ups, and learn phrases locals actually use. Our weekly reports decode what's happening in Seoul's hottest neighborhoods, from Gangnam to Hongdae.",
      "hero.description.paragraph2":
        "Stay ahead with our curated K-culture calendar featuring concerts, festivals, and exclusive pop-ups. Build your personalized phrasebook tailored to your interests—K-pop, Korean cuisine, or tech startups.",
      ...
      "popupRadar.description":
        "Limited-time collaborations, concept cafes, and exclusive experiences. Our radar tracks pop-ups across Seoul, Busan, and Jeju to discover unique experiences before they're gone.",
      ...
      "trends.description":
        "Our team in Seoul tracks the latest trends across fashion, food, entertainment, and lifestyle. Weekly reports on what's trending in neighborhoods like Myeongdong, Itaewon, and Seongsu.",
      "trends.description.link": "Follow",
      "trends.description.linkText": "#Seoul",
      "trends.description.linkSuffix": "on Instagram for more inspiration.",
      "trends.description2":
        "Explore our archive to discover hidden gems and find the best spots to visit.",
      ...
      "home.about.paragraph1":
        "Korea is more than K-pop and kimchi. A dynamic country where tradition meets innovation, with new trends emerging every week.",
      "home.about.paragraph2":
        "Our team based in Seoul explores the city to bring you the latest insights. From hidden cafes in Seongsu to pop-ups in Gangnam, we cover the trends that matter.",
      ...
      "home.tutoring.badge": "Korean Tutoring",
      "home.tutoring.title": "Learn Korean with Gen Z Tutors",
      "home.tutoring.subtitle": "Personalized lessons based on current trends, taught by passionate young Koreans.",
      "home.tutoring.cta": "Discover",
      "home.tutoring.card.title": "Personalized Korean Lessons",
      "home.tutoring.card.description": "Learn everyday Korean with tutors who understand modern culture. From trendy expressions to real-life situations.",
      "home.tutoring.card.cta": "Learn more",
      "home.tutoring.advantage.trendBased.title": "Trend-Based Learning",
      "home.tutoring.advantage.trendBased.description": "Learn with current content: K-pop, dramas, internet slang, and viral expressions.",
      "home.tutoring.advantage.genZPeer.title": "Gen Z Tutors",
      "home.tutoring.advantage.genZPeer.description": "Practice with young Koreans who speak like locals and understand your generation.",
      "home.tutoring.advantage.realLifeMission.title": "Real-Life Missions",
      "home.tutoring.advantage.realLifeMission.description": "Put your knowledge into practice with real challenges: ordering at cafes, talking to locals.",
      "home.membership.badge": "Membership",
      "home.membership.title": "Choose Your Plan",
      "home.membership.subtitle": "Flexible options for all levels and learning goals.",
      "home.membership.basic.title": "Basic",
      "home.membership.basic.price": "$49",
      "home.membership.basic.sessions": "4 sessions / month",
      "home.membership.basic.feature1": "50-min 1-on-1 sessions",
      "home.membership.basic.feature2": "Learning materials included",
      "home.membership.pro.badge": "Popular",
      "home.membership.pro.title": "Pro",
      "home.membership.pro.price": "$89",
      "home.membership.pro.sessions": "8 sessions / month",
      "home.membership.pro.feature1": "50-min 1-on-1 sessions",
      "home.membership.pro.feature2": "Learning materials included",
      "home.membership.pro.feature3": "Priority support",
      "home.membership.learnMore": "Learn More",
      "home.membership.getStarted": "Get Started",
      "home.membership.viewAll": "View All Plans"
    }
  }
};
