...
const translations: TranslationDictionary = {
  fr: {
    ...
    messages: {
      ...
      "profile.badge": "Mon espace Decorée",
      "profile.title": "Votre profil Decorée",
      "profile.subtitle":
      ...
      "profile.section.identityHint":
        "Le nom saisi apparaît sur vos espaces personnels et communications Decorée.",
      ...
      "profile.section.accountHint":
        "Les métadonnées proviennent de Firebase et sécurisent votre accès Decorée.",
      ...
      "profile.bookmarks.empty":
        "Aucun favori pour le moment. Ajoutez-en depuis les cartes Decorée.",
  ...
  ko: {
    ...
    messages: {
      ...
      "profile.badge": "Decorée 마이페이지",
      "profile.title": "내 프로필 관리",
      "profile.subtitle": "표시 이름을 수정하고 Decorée 계정 정보를 확인하세요.",
      ...
      "profile.noUser.subtitle": "Decorée 계정으로 로그인하면 마이페이지를 사용할 수 있습니다.",
  ...
  ja: {
    ...
    messages: {
      ...
      "hero.highlights.title": "Decorée一覧",
      ...
      "profile.badge": "Decorée マイページ",
      "profile.title": "プロフィール管理",
      "profile.subtitle": "表示名を更新し、Decoréeアカウント情報を確認しましょう。",
      ...
      "profile.noUser.subtitle": "Decoréeにログインするとマイページを利用できます。",
  ...
  en: {
    ...
    messages: {
      ...
      "profile.bookmarks.empty":
        "No bookmarks yet. Tap the bookmark icon on any Decorée card to save it.",
