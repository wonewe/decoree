    ...
    <article className="bg-white">
      <div className="relative h-[340px] w-full overflow-hidden">
        ...
        <div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-black/70 to-transparent px-6 py-8 text-white">
          ...
          <p className="mt-2 max-w-3xl text-2xl text-slate-100 md:text-3xl">{report.summary}</p>
        </div>
      </div>
      ...
      <div className="section-container">
        ...
        <div className="prose prose-2xl md:prose-2xl prose-slate max-w-4xl text-slate-700">
            ...
            if (isHtml) {
              return (
                <div
                  ...
                  className="mb-6 leading-relaxed [&_p]:mb-1 md:[&_p]:mb-2 [&_p]:text-2xl md:[&_p]:text-3xl [&_img]:my-5 [&_img]:mx-auto [&_img]:block [&_img]:h-auto [&_img]:w-auto [&_img]:max-w-full [&_img]:rounded-2xl [&_img]:object-contain [&_img]:shadow-md [&_img]:resize [&_img]:overflow-auto [&_img]:cursor-nwse-resize [&_img]:min-w-[200px] [&_h2]:mt-7 [&_h2]:mb-2 [&_h2]:text-4xl [&_h2]:font-semibold"
                />
              );
            }
            // 일반 텍스트인 경우
            return (
              <p key={index} className="mb-1 md:mb-2 text-2xl md:text-3xl leading-relaxed text-slate-700">
                {paragraph}
              </p>
            );
          })}
