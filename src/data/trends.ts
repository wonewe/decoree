...
export const TREND_REPORTS: TrendReport[] = [
  {
    ...
    intensity: "highlight",    publishedAt: "2024-06-03",
  ...
  },
  {
    ...
    intensity: "insider",    publishedAt: "2024-06-05",
    imageUrl: BLANK_IMAGE,
    content: [
  ...
  },
  {
    ...
    intensity: "emerging",    publishedAt: "2024-06-02",
    imageUrl: BLANK_IMAGE,
    content: [
  ...
  },
  {
    ...
    tags: ["커피", "베이커리", "로컬"],
    intensity: "insider",    publishedAt: "2024-06-14",
    imageUrl: BLANK_IMAGE,
    content: [
  ...
  },
  {
    ...
    intensity: "highlight",    publishedAt: "2024-06-07",
    imageUrl: BLANK_IMAGE,
    content: [
  ...
  },
  {
    ...
    intensity: "insider",    publishedAt: "2024-06-12",
    imageUrl: BLANK_IMAGE,
    content: [
      "益善洞の細い路地には、韓屋を改装した工房やギャラリーが点在。日本語サポート付きの工房を厳選したリストをニュースレターで共有しています。",
  ...
  },
  {
    ...
    intensity: "highlight",    publishedAt: "2024-06-15",
    imageUrl: BLANK_IMAGE,
    content: [
      ...
      "Subscribe to the newsletter to download an interactive map with time slots and queue intel to maximise the trail."
    ],
    authorId: "maya-h"
  },
  {
    ...
    intensity: "insider",    publishedAt: "2024-06-18",
    imageUrl: BLANK_IMAGE,
    content: [
  ...
  },
  {
    ...
    intensity: "emerging",    publishedAt: "2024-06-22",
    imageUrl: BLANK_IMAGE,
    content: [
