    ...
    <div className="fixed bottom-5 right-5 z-40 flex flex-col items-end gap-2">
      <div className="relative flex flex-col items-end gap-2">
        {bubbleVisible && (
          <div className="flex items-center gap-2">
            <button
              ...
              className="max-w-xs rounded-2xl border border-[var(--border)] bg-[var(--paper)] px-3 py-2.5 text-left text-xs font-semibold text-[var(--ink)] shadow-sm transition hover:-translate-y-0.5 hover:shadow-md focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--ink)] focus-visible:ring-offset-2"
            >
              {suggestion ? (
                <>
            ...
            <button
              ...
              className="min-h-[44px] min-w-[44px] rounded-full border border-[var(--border)] bg-[var(--paper-muted)] px-2 py-1 text-[10px] font-semibold text-[var(--ink-muted)] hover:border-[var(--ink)] hover:text-[var(--ink)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--ink)] focus-visible:ring-offset-2"
              aria-label="닫기"
            >
              ×
            </button>
        ...
        <button
          ...
          className="flex h-14 w-14 min-h-[44px] min-w-[44px] items-center justify-center rounded-full border border-[var(--border)] bg-[var(--paper)]/85 text-lg shadow-sm backdrop-blur transition hover:-translate-y-0.5 hover:shadow-md focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--ink)] focus-visible:ring-offset-2"
          aria-label="피드백 열기"
        >
          <div
          ...
          <div className="absolute bottom-[calc(100%+10px)] right-0 w-80 rounded-2xl border border-[var(--border)] bg-white/95 p-4 shadow-xl backdrop-blur">
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                className="min-h-[44px] min-w-[44px] text-xs font-semibold text-[var(--ink-subtle)] hover:text-[var(--ink)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--ink)] focus-visible:ring-offset-2 rounded"
                aria-label="닫기"
              >
                ×
              </button>
            ...
            <div className="mt-3 space-y-3">
              <div className="flex items-center justify-between text-[11px] font-semibold text-[var(--ink-subtle)]">
                ...
                <button
                  ...
                  className="min-h-[44px] px-2 py-1 text-[var(--ink-muted)] hover:text-[var(--ink)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--ink)] focus-visible:ring-offset-2 rounded"
                >
                  {copy.refresh}
                </button>
              </div>
          ...
          <div className="absolute bottom-[calc(100%+10px)] right-0 w-80 rounded-2xl border border-[var(--border)] bg-white/95 p-4 shadow-xl backdrop-blur">
            ...
            <div className="mt-3 space-y-2">
              <textarea
                ...
                rows={3}
                className="w-full rounded-xl border border-[var(--border)] bg-[var(--paper-muted)] px-3 py-2 text-sm text-[var(--ink)] focus:border-[var(--ink)] focus:outline-none focus:ring-1 focus:ring-[var(--ink)]"
              ...
              <div className="flex justify-end gap-2">
                <button
                  type="button"
                  onClick={() => setFeedbackOpen(false)}
                  className="min-h-[44px] rounded-full border border-[var(--border)] px-3 py-2.5 text-xs font-semibold text-[var(--ink-muted)] hover:border-[var(--ink)] hover:text-[var(--ink)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--ink)] focus-visible:ring-offset-2"
                >
                  {copy.close}
                </button>
                <button
                  type="button"
                  onClick={handleSend}
                  className="min-h-[44px] rounded-full bg-[var(--ink)] px-3 py-2.5 text-xs font-semibold text-white shadow-sm transition hover:-translate-y-0.5 hover:shadow-md focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--ink)] focus-visible:ring-offset-2 disabled:opacity-60 disabled:cursor-not-allowed"
